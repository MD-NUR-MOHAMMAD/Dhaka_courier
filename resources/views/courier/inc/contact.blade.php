<section>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-5 col-xl-4"><img src="{{ asset('courier/public/assets/img/illustrations/callback.png ')}}" alt="..." />
            ...
            <div class="col-md-6 col-lg-5 col-xl-4">
                <form class="row">
                    ...
                    <div class="mb-5">
                        ...
                        <textarea class="form-control form-quriar-control is-invalid border-400" id="validationTextarea" placeholder="Message"
